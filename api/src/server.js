...
server.listen(PORT, async () => {
    await sequelize.sync({ force: true })// sequelize.async 'sincroniza sequelize con postgres
    //force: false, - force:true cada ves que se levanta server crea las tablas e delete it created
    //{alter:true} datos existentes y solo aplicar cambios en la estructura (como agregar o modificar columnas)
    await saveApiData();
